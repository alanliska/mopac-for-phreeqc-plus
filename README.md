...
$ cmake .. -DCMAKE_INSTALL_PREFIX=/path/to/install -DSTATIC_BUILD=ON -DAUTO_BLAS=OFF -DTHREADS_KEYWORD=OFF -DMOPAC_LINK="-static -fPIE -pie -Wl,-z,max-page-size=16384 /path/to/liblapack.a /path/to/libblas.a" -DGPU=OFF -DTESTS=OFF
```
...
$ export FFLAGS="-pie -fPIC"
$ export LDFLAGS="-static -pie -fPIC -Wl,-z,max-page-size=16384"
$ cmake .. -DCMAKE_INSTALL_PREFIX=/path/to/install -DSTATIC_BUILD=ON -DAUTO_BLAS=OFF -DTHREADS_KEYWORD=ON -DMOPAC_LINK="-static -fPIE -pie -Wl,-z,max-page-size=16384 /path/to/liblapack.a /path/to/libblas.a" -DGPU=OFF -DTESTS=OFF
```
